...
function script_fish:setup()
	...
	if skillLevel >= 300 and HasItem("Aracanite Fishing Pole") then
		self.poleName = "Arcanite Fishing Pole";
	elseif skillLevel >= 100 and HasItem("Big Iron Fishing Pole") then
		self.poleName = "Big Iron Fishing Pole";
	elseif skillLevel >= 50 and HasItem("Darkwood Fishing Pole") then
		self.poleName = "Darkwood Fishing Pole";
	elseif skillLevel >= 10 and HasItem("Strong Fishing Pole") then
		self.poleName = "Strong Fishing Pole";
	elseif HasItem("Blump Family Fishing Pole") then
