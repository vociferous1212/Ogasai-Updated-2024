...
function grind2MoneyCounter:silverFromGold()
	...
	local silver = math.floor(grind2.totalGainedMoney - (grind2MoneyCounter:goldFromCopper() * 100));
...
function grind2MoneyCounter:copperFromGold()
	...
	local copper = math.floor(grind2.totalGainedMoney - (grind2MoneyCounter:goldFromCopper() * 10000));
