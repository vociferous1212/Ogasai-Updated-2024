...
function script_warlockEX:menu()
	...
	if (CollapsingHeader("Warlock Combat Options")) then
		...
		script_warlock.drinkMana = SliderInt("M%", 1, 100, script_warlock.drinkMana);
		
		Text('Eat below health percentage');
		
		script_warlock.eatHealth = SliderInt("H%", 1, 100, script_warlock.eatHealth);
			
		Text('Use health potions below percentage');
		
		script_warlock.potionHealth = SliderInt("HP%", 1, 99, script_warlock.potionHealth);
		
		Text('Use mana potions below percentage');
		
		script_warlock.potionMana = SliderInt("MP%", 1, 99, script_warlock.potionMana);
