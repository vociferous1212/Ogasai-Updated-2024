		...
		if (HasSpell("Devotion Aura")) then
			if (CollapsingHeader("|+| Auras and Blessings")) then
				...
				if (HasSpell("Blessing of Might")) then
					...
					local z = script_paladin.might; local y = script_paladin.wisdom; x = script_paladin.kings;
					...
					SameLine();
					wasClicked, script_paladin.kings = Checkbox("Blessing of Kings", script_paladin.kings);

					if z then
						script_paladin.wisdom = false;
						script_paladin.kings = false;
					end
					if y then
						script_paladin.might = false;
						script_paladin.kings = false;
					end
					if x then
						script_paladin.might = false;
