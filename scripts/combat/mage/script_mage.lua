script_mage = {
	...
	pullSpellsIncluded = include("scripts\\combat\\script_magePullSpells.lua"),
	mageRestIncluded = include("scripts\\combat\\script_mageRest.lua"),
	magePolymorphIncluded = include("scripts\\combat\\script_magePolymorph.lua"),
