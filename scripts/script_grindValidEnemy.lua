	...
	if _quest.usingQuester then
        ...
        if (script_grind.skipHardPull) and (not script_grind.extraSafe) and (not script_grindEX.avoidBlacklisted)
            ...
            if (not i:IsDead() and i:CanAttack() and not i:IsCritter()
                ...
                and not (script_grind.skipAberration and i:GetCreatureType() == 'Abberration')
                and not (script_grind.skipDragonkin and i:GetCreatureType() == 'Dragonkin')
                and not (script_grind.skipGiant and i:GetCreatureType() == 'Giant')
                and not (script_grind.skipMechanical and i:GetCreatureType() == 'Mechanical')
