...
-- elwynn forest
	...
	hotspotDB:addHotspot('North Shire 2 - 3', "Alliance", 2, 3, -8724.425, -137.0334, 86.89613);
	hotspotDB:addHotspot("Echo Ridge Mine 2 - 4", "Alliance", 2, 4, -8721.64, -106.24, 86.92);
	hotspotDB:addHotspot("Northshire Valley 4 - 6", "Alliance", 4, 6, -8863.01, -416.01, 66.07);
...
-- Durotar
	...
	hotspotDB:addHotspot("Valley of Trials 3 - 3", "Horde", 2, 3, -504.94, -4109.4, 56.76);
	hotspotDB:addHotspot("Valley of Trials 4 - 5", "Horde", 4, 5, -236.64, -4332.44, 64.6);
	hotspotDB:addHotspot("Durotar 6 - 8", "Horde", 6, 8, -856.81, -4656.28, 33.61);
	hotspotDB:addHotspot("Kolkar Crag 8 - 10", "Horde", 8, 10, -969.67, -4605.44, 25.21);
	hotspotDB:addHotspot("Durotar 6 - 8", "Horde", 6, 8, -404.65, -4848.86, 37.59);
	hotspotDB:addHotspot("Tiragarde Keep 8 - 10", "Horde", 8, 10, -154.91, -5070.73, 21.32);
	hotspotDB:addHotspot("Durotar 6 - 8", "Horde", 6, 8, 271.78, -5073.19, 11.39);
	hotspotDB:addHotspot("Durotar 9 - 11", "Horde", 9, 11, 631.88, -4264.21, 15.26);
	hotspotDB:addHotspot("Southfury River 9 - 11", "Horde", 9, 11, 386.82, -3860.99, 29.52);
	hotspotDB:addHotspot("Durotar 10 - 12", "Horde", 10, 12, -154.7, -3894.87, 42.71);
	hotspotDB:addHotspot("Durotar 9 - 11", "Horde", 9, 11, 1219.31, -4056.61, 21.59);
-- Tirisfal Glades
	hotspotDB:addHotspot("Deathknell 1 - 2", "Horde", 1, 2, 1920.98, 1656.87, 80.98);
	hotspotDB:addHotspot("Deathknell 2 - 3", "Horde", 2, 3, 2115.48, 1691.57, 73.04);
	hotspotDB:addHotspot("Deathknell 3 - 3", "Horde", 3, 4, 1888.2, 1299.41, 95.87);
	hotspotDB:addHotspot("Deathknell 4 - 6", "Horde", 4, 6, 1870.24, 1387.63, 78.07);
	hotspotDB:addHotspot("Night Web's Hollow 4 - 5", "Horde", 4, 5, 2049.17, 1819.51, 106.76);
	hotspotDB:addHotspot("Tirisfal Glades 8 - 10", "Horde", 8, 10, 2534.28, 1057.37, 84.39);
	hotspotDB:addHotspot("Stillwater Pond 7 - 9", "Horde", 7, 9, 2361.71, 763.79, 38.95);
	hotspotDB:addHotspot("Tirisfal Glades 6 - 8", "Horde", 6, 8, 2645, 221.65, 33.31);
	hotspotDB:addHotspot("Tirisfal Glades 8 - 10", "Horde", 8, 10, 1823.31, -559.25, 38.7);
	hotspotDB:addHotspot("Venomweb Vale 9 - 11", "Horde", 9, 11, 2250.96, -915.7, 75.42);
end