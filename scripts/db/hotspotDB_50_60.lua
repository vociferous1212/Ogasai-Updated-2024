...
-- Eastern Plaguelands
	hotspotDB:addHotspot("Light's Hope Chapel 55 - 60", "All", 55, 57, 2127.77, -5252.62, 95.23);
...
-- Un'Goro Crater
	...
	hotspotDB:addHotspot("Un'Goro Crater 53 - 55", "All", 53, 55, -6689.96, -2109.86, -272.1);
...
-- Silithus
	hotspotDB:addHotspot("Marshal's Refuge 55 - 57", "All", 55, 57, -6178.36, -1095.55, -212.45);
