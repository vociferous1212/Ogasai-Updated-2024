...
function hotspotDB_10_20:setup()
...
-- Barrens
	...
	hotspotDB:addHotspot("The Barrens 12 - 13", "Horde", 12, 13, 257.04, -2593.1, 94.02);
	hotspotDB:addHotspot("The Barrens 12 - 13", "Horde", 12, 13, -75.67, -2105.67, 91.66);
